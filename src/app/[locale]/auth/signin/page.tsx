        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Link href={`/${locale}/auth/forgot`} className="block text-right mt-1 text-xs text-purple-600 hover:underline">
                {t('forgotPassword')}
              </Link>
            </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            {t('noAccount')}{' '}
            <Link href={`/${locale}/auth/signup`} className="text-purple-600 font-semibold hover:underline">
              {t('createAccount')}
            </Link>
          </p>
        </div>
